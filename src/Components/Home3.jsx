...
function Home3() {
  return (
    <section class="bg-red-50 min-h-screen py-16 px-6">
    ...
    <button class="bg-gray-200 text-gray-700 px-4 py-2 rounded-full hover:bg-gray-300">Accessories</button>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
        <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition overflow-hidden group">
          ...
          <div class="p-6">
            ...
            <div class="flex justify-between items-center mt-4">
              <span class="text-lg font-semibold text-orange-600">$12.99</span>
              <button class="bg-orange-500 text-white px-4 py-2 rounded-4xl hover:bg-orange-800">
                Add To Cart
              </button>
            </div>
          </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition overflow-hidden group">
          <div class="relative">
            <img
              ...
              class="w-full h-60 object-cover group-hover:scale-105 transition-transform"
            />
            <span class="absolute top-3 right-3 bg-red-600 text-white text-xs px-2 py-1 rounded">
              SALE
            </span>
          </div>
          <div class="p-6">
            ...
            <div class="flex justify-between items-center mt-4">
              <span class="text-lg font-semibold text-orange-600">$14.99</span>
              <button class="bg-orange-500 text-white px-4 py-2 rounded-4xl hover:bg-orange-800">
                Add To Cart
              </button>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition overflow-hidden group">
          ...
          <div class="p-6">
            <h3 class="text-lg font-bold text-gray-900 mb-1">Vegetarian</h3>
            <p class="text-sm text-gray-500 mb-2">
              Tomato sauce, mozzarella, bell peppers, mushrooms, and olives.
            </p>
            <div class="flex justify-between items-center mt-4">
              <span class="text-lg font-semibold text-orange-600">$13.99</span>
              <button class="bg-orange-500 text-white px-4 py-2 rounded-4xl hover:bg-orange-800">
                Add To Cart
              </button>
            </div>
